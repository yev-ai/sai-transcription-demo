...
export const createAnycastTunnelTarget = (
...
export const createTunnelWithRoute = (
  ...
  const tunnelConfig = new ZeroTrustTunnelCloudflaredConfig(
    `${resourcePrefix}-twr-config`,
    {
      tunnelId: tunnel.id,
      accountId: accountId,
      config: {
